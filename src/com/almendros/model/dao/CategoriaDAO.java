...
public class CategoriaDAO implements Serializable {
    ...
    public void create(Categoria categoria) {
        ...
        try {
            ...
            for (Producto productoListProductoToAttach : categoria.getProductoList()) {
                productoListProductoToAttach = em.getReference(productoListProductoToAttach.getClass(), productoListProductoToAttach.getCodigoProducto());
    ...
    public void edit(Categoria categoria) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Producto productoListNewProductoToAttach : productoListNew) {
                productoListNewProductoToAttach = em.getReference(productoListNewProductoToAttach.getClass(), productoListNewProductoToAttach.getCodigoProducto());
    ...
    public Categoria findCategoriasName(String name) {
        EntityManager em = getEntityManager();
        Categoria cat = null;
        try {
            cat = em.createNamedQuery("Categoria.findByName", Categoria.class).setParameter("tipoMadera", name + "%").getSingleResult();
        } catch (Exception e) {
            cat = null;
            return cat;
        }
    ...
    public String autoIncrement() {
        ...
        String sql = "SELECT AUTO_INCREMENT FROM information_schema.tables WHERE TABLE_SCHEMA = \"ALMENDROS\" AND TABLE_NAME = \"Categorias\"";
